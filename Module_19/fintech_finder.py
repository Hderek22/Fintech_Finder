...
candidate_database = {
    "Rachel": ["Rachel", "0xaC8eB8B2ed5C4a0fC41a84Ee4950F417f67029F0", "4.3", .20, "Images/rachel.jpeg"],
...
st.sidebar.write("## Acount balance = ")
...
st.sidebar.write("Hourly wage = ",wage)
